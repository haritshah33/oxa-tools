...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/haritshah33/edx-configuration.git
CONFIGURATION_VERSION=omaster
PLATFORM_REPO=https://github.com/haritshah33/edx-platform.git
